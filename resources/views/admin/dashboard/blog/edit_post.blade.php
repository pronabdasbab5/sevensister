      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('update_post', ['postId' => $blogData->id]) }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Post Title : <span class="required">*</span></label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="text" name="post_title" id="post_title" value="{{ $blogData->blogTitle }}" class="form-control col-md-7 col-xs-12" placeholder="Post Title" required>
                    @error('post_title')
                        {{ $message }}
                    @enderror
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <textarea name="post_desc" id="post_desc" required>{{ $blogData->desc }}</textarea>
                    @error('post_desc')
                        {{ $message }}
                    @enderror
                </div>
